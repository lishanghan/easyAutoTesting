 ...
 * want it to be hry to override individual options on a child
  ...
  if (options && options['children']) {
    ...
    vjs.obj.each(options['children'], function(name, opts){
      ...
      var tempAdd = function(){
        // Set property name on player. Could cause conflicts with other prop names, but it's worth making refs hry.
