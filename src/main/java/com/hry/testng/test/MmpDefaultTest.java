...
public class MmpDefaultTest extends Base{
    ...
    @Test(testName = "/fund/detail", dataProvider = "provider", description = "获取产品明细")
    ...
    @Test(testName = "/fund/customerList", dataProvider = "provider", description = "获取产品明细-购买客户 待补充")
    ...
    @Test(testName = "/fund/fundInfo", dataProvider = "provider", description = "获取产品明细")
    ...
    @Test(testName = "/customer/list", dataProvider = "provider", description = "查询系统客户经理名下客户列表")
    ...
    @Test(testName = "/business/appoints", dataProvider = "provider", description = "listAppoint")
    ...
    @Test(testName = "/fund/list/crm", dataProvider = "provider", description = "获取CRM产品列表")
    public void fund_list_crm(HryTest test) {
        String actual = HryHttpClientUtil.send(test, this);
        supperAssert(actual, test);
    }

    @Test(testName = "/fund/onsale/list", dataProvider = "provider", description = "获取在售产品列表")
